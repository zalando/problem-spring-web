...
public final class MultipartAdviceTraitTest implements AdviceTraitTest<MultipartAdviceTrait> {

    @ControllerAdvice
    private static class Advice implements MultipartAdviceTrait {

    }

    @Override
    public MultipartAdviceTrait unit() {
        return new Advice();
    }
