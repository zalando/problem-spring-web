...
public final class MessageNotReadableAdviceTraitTest implements AdviceTraitTest<MessageNotReadableAdviceTrait> {

    @ControllerAdvice
    private static class Advice implements MessageNotReadableAdviceTrait {

    }

    @Override
    public MessageNotReadableAdviceTrait unit() {
        return new Advice();
    }
