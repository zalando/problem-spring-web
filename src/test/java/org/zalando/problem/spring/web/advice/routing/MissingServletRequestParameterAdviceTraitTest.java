...
public final class MissingServletRequestParameterAdviceTraitTest implements AdviceTraitTest<MissingServletRequestParameterAdviceTrait> {

    @ControllerAdvice
    private static class Advice implements MissingServletRequestParameterAdviceTrait {

    }

    @Override
    public MissingServletRequestParameterAdviceTrait unit() {
        return new Advice();
    }
