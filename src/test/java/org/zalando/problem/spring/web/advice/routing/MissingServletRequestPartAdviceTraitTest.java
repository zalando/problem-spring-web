...
public final class MissingServletRequestPartAdviceTraitTest implements AdviceTraitTest<MissingServletRequestPartAdviceTrait> {

    @ControllerAdvice
    private static class Advice implements MissingServletRequestPartAdviceTrait {

    }

    @Override
    public MissingServletRequestPartAdviceTrait unit() {
        return new Advice();
    }
