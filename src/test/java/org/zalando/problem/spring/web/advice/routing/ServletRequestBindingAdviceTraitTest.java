...
public final class ServletRequestBindingAdviceTraitTest implements AdviceTraitTest<ServletRequestBindingAdviceTrait> {

    @ControllerAdvice
    private static class Advice implements ServletRequestBindingAdviceTrait {

    }

    @Override
    public ServletRequestBindingAdviceTrait unit() {
        return new Advice();
    }
